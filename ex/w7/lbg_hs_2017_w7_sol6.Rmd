...
cat("$$D = \\left[")
cat(paste(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matD, pnDigits = 4), collapse = "\n"))
cat("\\right]\n")
cat("$$\n")
```
...
matL <- matR %*% matSInv
cat("$$L = \\left[")
cat(paste(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matL, pnDigits = 4), collapse = "\n"))
cat("\\right]\n")
cat("$$\n")
```

c) Aufgrund der Matrizen $L$ und $D$, welche einfach zu invertieren sind, finden wir auch einfach die Inverse $A^{-1}$. 

```{r}
matDInv <- solve(matD)
cat("$$D^{-1} = \\left[")
cat(paste(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matDInv, pnDigits = 4), collapse = "\n"))
cat("\\right]\n")
cat("$$\n")
```
...
matLInv <- solve(matL)
cat("$$L^{-1} = \\left[")
cat(paste(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matLInv, pnDigits = 4), collapse = "\n"))
cat("\\right]\n")
cat("$$\n")
```
...
cat(paste(rmddochelper::sConvertMatrixToLaTexArray(pmatAMatrix = matAInv, pnDigits = 4), collapse = "\n"))
cat("\\right]\n")
cat("$$\n")
```
