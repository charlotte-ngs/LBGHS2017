...
The _proof_ shows that $H^2 = GAGA = GA$, because $AGA = A$, showing that $H$ is idempotent. By the rule of ranks of product matrix, $r(H) = r(GA) \le r(A)$. Because $AH = AGA = A$, we have $r(H) \ge r(A)$. Therefore $r(H) = r(A)$. Because $H$ is idempotent, so is $I-H$ and $r(I-H) = tr(I-H) = q - tr(H) = q - r(H) = q-r$. {TODO: More research on ranks of matrix products is needed here.}
