# Berechnung der Inzucht
```{r Chapter07Setup, include=FALSE}
...
```{r 07_PedEx1, results='markup', eval=TRUE}
...
\begin{center}
```{r SummaryResult, results='markup'}
