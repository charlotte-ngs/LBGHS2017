...
```{r ZuechtungElternNachkommen, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, odg.out.format=c("pdf","png"), fig.align='center', echo=FALSE, results='asis', out.width="6cm"}
knitr::include_graphics(path = "png/ZuechtungElternNachkommen.png")
```
...
```{r VermehrungElternNachkommen, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, odg.out.format=c("pdf","png"), fig.align='center', echo=FALSE, results='asis', out.width="6cm"}
knitr::include_graphics(path = "png/VermehrungElternNachkommen.png")
```
...
```{r RegPhenAddGen, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, odg.out.format=c("pdf","png"), fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "png/RegPhenAddGen.png")
```
