...
```{r PhenotypeGenotypSchema, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "PhenotypeGenotypSchema.pdf")
```
...
```{r GenotypischerWert, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "GenotypischerWert.pdf")
```
