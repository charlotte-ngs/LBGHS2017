...
```{r ScreenShotCRAN, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, png.path="png", fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "ScreenShotCRAN.pdf")
```


Zusätzlich zu R empfielt es sich, die Entwicklungsumgebung RStudio (https://www.rstudio.com/) zu verwenden.

```{r ScreenShotRstudio, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "ScreenShotRstudio.pdf")
```
...
```{r vonNeumannComputerArch, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis'}
knitr::include_graphics(path = "vonNeumannComputerArch.pdf")
```
...
```{r Arbeitsspeicher1, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis', out.width="5cm"}
knitr::include_graphics(path = "Arbeitsspeicher1.pdf")
```
...
```{r Arbeitsspeicher2, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis', out.width="5cm"}
knitr::include_graphics(path = "Arbeitsspeicher2.pdf")
```
...
```{r Arbeitsspeicher3, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis', out.width="5cm"}
knitr::include_graphics(path = "Arbeitsspeicher3.pdf")
```
...
```{r ArbeitsspeicherZugriff, conv.odg=TRUE, odg.path="odg", odg.graph.cache=TRUE, fig.align='center', echo=FALSE, results='asis', out.width="5cm"}
knitr::include_graphics(path = "ArbeitsspeicherZugriff.pdf")
```
