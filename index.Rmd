...
# w6
dfSolTable$vecSolThema[which(Datum == format(as.Date("2017/11/03"), "%d.%m"))] <- "[Inverse  Verwandtschaftsmatrix](https://charlotte-ngs.github.io/LBGHS2017/sol/w6/lbg_hs_2017_w6_sol5.pdf)"
# w7
dfSolTable$vecSolThema[which(Datum == format(as.Date("2017/11/10"), "%d.%m"))] <- "[Berechnung der Inzucht](https://charlotte-ngs.github.io/LBGHS2017/sol/w7/lbg_hs_2017_w7_sol6.pdf)"
