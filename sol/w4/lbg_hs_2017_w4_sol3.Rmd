...
Gemäss der Übersichtstabelle in den Unterlagen hängen die Zuchtwerte alle vom Term $\alpha$ ab. Deshalb berechnen wir diesen als Vorbereitung. Es gilt
...
a) Die Übersichtstabelle aus den Unterlagen sieht dann wie folgt aus.
...
b) Aufgrund der Selektion ändern sich die Allelfrequenzen zu $p = `r p`$ und $q = `r q`$. Auch $\alpha$ ändert sich zu $\alpha = `r alpha`$. Dies hat folgende Auswirkungen auf die Werte in der Übersichtstabelle aus den Unterlagen.
